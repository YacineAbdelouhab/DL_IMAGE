...
def plot_curves(results: dict, model_name: str) -> plt.Figure:
    ...
    # Loss
    axes[0].plot(epochs_range, results["train_losses"], 'o-', label="Train", linewidth=2)
    axes[0].plot(epochs_range, results["val_losses"], 's-', label="Val", linewidth=2)
    ...
    # Accuracy
    axes[1].plot(epochs_range, results["train_accs"], 'o-', label="Train", linewidth=2)
    axes[1].plot(epochs_range, results["val_accs"], 's-', label="Val", linewidth=2)
    ...
    # AUC
    axes[2].plot(epochs_range, results["train_aucs"], 'o-', label="Train", linewidth=2)
    axes[2].plot(epochs_range, results["val_aucs"], 's-', label="Val", linewidth=2)
    axes[2].set_xlabel("Epoch", fontsize=12)
    axes[2].set_ylabel("AUC", fontsize=12)
    axes[2].set_title("ROC-AUC", fontsize=13, fontweight="bold")
    axes[2].legend()
